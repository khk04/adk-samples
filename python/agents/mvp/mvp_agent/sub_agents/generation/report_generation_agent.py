...
from .tools.data_analysis_tool import data_analysis_tool, artifact_files_tool, save_artifact_tool
...
data_analysis_report_agent = Agent(
    ...
    tools=[data_analysis_tool, artifact_files_tool, save_artifact_tool, report_generation_tool],
